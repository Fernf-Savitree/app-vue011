          ...
          <div class="modal-body">
            <form @submit.prevent="saveEmployee">
              ...
              <div class="mb-3">
                ...
                <input v-model="editEmployee.salary" type="text" class="form-control" required>
              </div>
              <div class="mb-3">
                <label class="form-label">สถานะ</label>
                <input v-model="editEmployee.active" type="text" class="form-control" required>
              </div>
...
export default {
  ...
  setup() {
    ...
    const fetchEmployees = async () => {
      try {
        const response = await fetch("http://localhost/app-vue011/php_api/employee_crud.php");
    ...
    const saveEmployee = async () => {
      const url = "http://localhost/app-vue011/php_api/employee_crud.php";
